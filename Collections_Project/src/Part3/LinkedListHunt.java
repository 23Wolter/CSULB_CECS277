 ...
 * November 12, 2018
 * Purpose: Create x number of teams and load a scavenger hunt list to each team in a LinkedList
...
public class LinkedListHunt {
    ...
    public static void main(String[] args) {
        ...
        for(int i=0; i<teams.length; i++) {
            System.out.println(teams[i].getLinkedListItems());
        }
        ...
        for(int i=0; i<teams.length; i++) {
            System.out.println(teams[i].getLinkedListItems().get(userInput));
        }
        ...
        for(int i=0; i<teams.length; i++) {
            teams[i].getLinkedListItems().add(userInput, "Gold Medal");
        }
        //Get current time minus last timestamp3
        time = System.nanoTime() - time;
        System.out.println(time + " ns, " + time/1000000 + " ms");
